    ...
    <div class="container">
        <div class="auth-card" style="max-width:550px;">
            <div class="auth-header">
                <i class="fas fa-user-plus" style="color:var(--success);font-size:3rem;"></i>
                <h1>Create Account</h1>
                <p>Join as a Blood Donor / Recipient</p>
            </div>
            ...
            <form method="POST" action="<?php echo APP_URL; ?>/auth/user-register" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="terms-scroll-box">
                        ...
                        <p><strong>7. Donation Interval Responsibility</strong><br>If you have previously donated blood — whether through JeevanDaan or any other organisation — and attempt to donate again before the required minimum gap of <strong>3 months (90 days)</strong>, this is entirely your own responsibility. JeevanDaan will not be held liable for any health complications, adverse effects, or medical consequences arising from premature re-donation. It is your duty to disclose your accurate last donation date during registration and screening.</p>
                ...
                <button type="submit" class="btn btn-success btn-block btn-lg" id="submitBtn" disabled>
            ...
            <div style="text-align:center;margin:20px 0;">
                ...
                <a href="<?php echo APP_URL; ?>/auth/user-login" class="btn btn-outline">
            ...
            <a href="<?php echo APP_URL; ?>/auth/google-user" 

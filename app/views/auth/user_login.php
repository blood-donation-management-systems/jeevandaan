    ...
    <div class="container">
        <div class="auth-card" style="max-width:480px;">
            <div class="auth-header">
                <i class="fas fa-user" style="color:var(--success);font-size:3rem;"></i>
                <h1>User Login</h1>
            ...
            <form method="POST" action="<?php echo APP_URL; ?>/auth/user-login">
                ...
                <div class="forgot-link">
                    <a href="<?php echo APP_URL; ?>/auth/forgot-password?type=user">
            ...
            <div style="text-align:center;margin:20px 0;">
                ...
                <a href="<?php echo APP_URL; ?>/auth/user-register" class="btn btn-outline">
